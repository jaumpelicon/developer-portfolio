  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: 'Swift', level: 85, color: 'from-orange-400 to-orange-600' },
        { name: 'React Native', level: 75, color: 'from-cyan-400 to-cyan-600' }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: 'Spring Boot (Kotlin)', level: 78, color: 'from-green-400 to-green-600' },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Git / GitLab / Azure', level: 90, color: 'from-gray-400 to-gray-600' },
        { name: 'Firebase / Mixpanel', level: 85, color: 'from-yellow-400 to-yellow-600' }
      ]
    }
  ]
        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            {[
              ...
              'Firebase', 'GraphQL', 'REST API', 'Dio', 'TypeScript', 'KMP'
            ].map((tech, index) => (
              <motion.span
                key={tech}
